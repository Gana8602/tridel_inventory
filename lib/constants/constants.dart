class Constants {
  ...
  static const String productsUrl = "http://192.168.0.128/api/productData.php";
  static const String localHost = "http://192.168.0.128/api";

  static const String totalStock = "Electrical Stock";
  static const String valueOfStock = "Mechanical Stock:";
  static const String productsCount = "Vendors";
  static const String customerCount = "Employees";
